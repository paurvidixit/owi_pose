...
def joint_positions_publisher():
	...
	pub1 = rospy.Publisher('/owi535/Elbow_Wrist_position_controller/command', Float64, queue_size=10)
	pub2 = rospy.Publisher('/owi535/Model_Rotation_Position_Controller/command', Float64, queue_size=10)
	pub3 = rospy.Publisher('/owi535/Base_Elbow_Position_Controller/command', Float64, queue_size=10)
